...
<!--           <div class="titlebn" >FEATURES</div>
 -->
	...
	<div class="container-fluid" style="padding:3%;padding-top:0px;" >
		<div class="row" style="" >
			<div align="center" style='' >
				<?php
	...
	<div class="container-fluid" style="padding:3%;padding-top:0px;" >
		<div class="row" style="background-color:#f0f0e8;" >
		 ...
		 <div class="col-xs-12" style="padding:20px;background-color:#ffcc00;"  align="center" >
		 ...
		 <div align="center" >
			...
			?>
				...
				<div class="container text-center" >
				 ...
				 ?>
				 <div class="col-xs-12 col-sm-2" style="<?php pit("border-right: 1px solid #dddddd;", $i<$imagelen-1 ); ?>cursor:pointer;" align='center' >
